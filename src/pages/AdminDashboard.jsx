...
export default function AdminDashboard() {
    ...
    return (
        <div className="min-h-screen flex bg-slate-950">
            {/* Sidebar */}
            <aside className="w-64 glass border-r border-indigo-500/10 sticky top-0 h-screen overflow-y-auto">
                <div className="p-6">
                    ...
                    <div className="mt-8 pt-8 border-t border-slate-700/50 space-y-2">
                        <Link to="/menu" className="block px-4 py-3 text-slate-400 hover:text-white hover:bg-slate-800 rounded-xl transition-all">
                            Ver Menú Público
                        </Link>
                        <button
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="hover:scale-105 transition-transform cursor-pointer group">
                    <div className="w-12 h-12 rounded-xl bg-blue-500/20 flex items-center justify-center text-2xl mb-4 group-hover:bg-blue-500/30 transition-colors">
                        📁
                    </div>
                ...
                <Card className="hover:scale-105 transition-transform cursor-pointer group">
                    <div className="w-12 h-12 rounded-xl bg-orange-500/20 flex items-center justify-center text-2xl mb-4 group-hover:bg-orange-500/30 transition-colors">
                        🍽️
                    </div>
                ...
                <Card className="hover:scale-105 transition-transform cursor-pointer group">
                    <div className="w-12 h-12 rounded-xl bg-purple-500/20 flex items-center justify-center text-2xl mb-4 group-hover:bg-purple-500/30 transition-colors">
                        🪑
                    </div>
                ...
                <Card className="hover:scale-105 transition-transform cursor-pointer group">
                    <div className="w-12 h-12 rounded-xl bg-emerald-500/20 flex items-center justify-center text-2xl mb-4 group-hover:bg-emerald-500/30 transition-colors">
                        📋
                    </div>
